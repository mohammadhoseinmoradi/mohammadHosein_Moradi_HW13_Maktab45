...
function dataShow(data) {
    ...
    let DATA = `
        ...
        <div class="info-large">
                ...
                <div class="price-big">
                    <span>${data[3].price}</span>${data[3].price} 
                </div>
                <h3>SIZE</h3>
                ...
                <div class="product-front">
                    ...
                    <div class="stats">        	
                        <div class="stats-container">
                            <span class="product_price">${data[3].price}</span>
                            <span class="product_name">${data[3].title}</span>    
                            <p>Summer dress</p>                                            
                ...
                <div class="product-back">
                    ...
                    <div class="carousel">
                        <ul class="carousel-container">
                            <li><img src=${data[3].img2} alt="" /></li>
                            <li><img src=${data[3].img3} alt="" /></li>
                            <li><img src=${data[3].img1} alt="" /></li>
                        </ul>
